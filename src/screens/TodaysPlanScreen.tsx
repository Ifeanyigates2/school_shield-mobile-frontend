  ...
  return (
    <View className="flex-1 bg-canvas">
      ...
      >
        ...
        <View className="bg-[#EDFDF3] rounded-3xl p-4.5 mb-3 border border-[#A6F4C5] shadow-xs">
          <View className="flex-row items-start gap-3 mb-3">
            <View className="w-6 h-6 rounded-full bg-[#12B76A] items-center justify-center mt-0.5">
              <Feather name="info" size={14} color="#FFFFFF" />
            </View>
            <View className="flex-1">
              <Text className="text-sm font-bold text-[#027A48]">
                You are authorized to drop-off {childFirstName}.
              </Text>
              <Text className="text-xs text-[#05603A] mt-1 leading-4">
          ...
          <Pressable
            className="bg-white border border-[#D0D5DD] h-11 rounded-2xl items-center justify-center active:bg-slate-50 shadow-xs"
            onPress={onOpenDropoff}
          >
            <Text className="text-slate-800 text-sm font-semibold">Manage drop-off</Text>
          </Pressable>
        </View>

        {/* NAVY ALERT CARD: PICKUP AUTHORIZATION */}
        <View className="bg-[#F0F4FA] rounded-3xl p-4.5 mb-6 border border-[#D5E1F2] shadow-xs">
          <View className="flex-row items-start gap-3 mb-3">
            <View className="w-6 h-6 rounded-full bg-[#0B1F3D] items-center justify-center mt-0.5">
              <Feather name="info" size={14} color="#FFFFFF" />
            </View>
            <View className="flex-1">
              <Text className="text-sm font-bold text-[#0B1F3D]">
                Chidinma Okafor is authorized to pick up {childFirstName}.
              </Text>
              <Text className="text-xs text-[#344054] mt-1 leading-4">
          ...
          >
            <Text className="text-slate-800 text-sm font-semibold">Manage pickup</Text>
          </Pressable>
        </View>
        ...
        <View className="bg-white rounded-3xl p-5 border border-line shadow-xs">
          ...
          <View className="flex-row gap-4">
            <Text className="w-16 text-xs font-bold text-ink pt-0.5">6:45 AM</Text>
            <View className="items-center">
              <View className="w-5 h-5 rounded-full bg-[#12B76A] items-center justify-center">
                <Feather name="check" size={12} color="#FFFFFF" />
              </View>
              <View className="w-0.5 h-16 bg-[#12B76A] my-1" />
            </View>
            <View className="flex-1 pb-4">
              <Text className="text-sm font-bold text-ink">Drop-off window opens</Text>
              <Text className="text-xs text-slate-500 mt-0.5">Main Gate · Primary 1–6</Text>
            </View>
          </View>

          {/* Milestone 2: 7:48 AM */}
          <View className="flex-row gap-4">
            <Text className="w-16 text-xs font-bold text-ink pt-0.5">{checkInTime}</Text>
            <View className="items-center">
              <View className="w-5 h-5 rounded-full bg-[#12B76A] items-center justify-center">
                <Feather name="check" size={12} color="#FFFFFF" />
              </View>
            ...
            <View className="flex-1 pb-4">
              <Text className="text-sm font-bold text-ink">{childFirstName} checked in</Text>
              <Text className="text-xs text-slate-500 mt-0.5">Main Gate · handed over by You</Text>
              <Text className="text-xs text-slate-600 font-medium mt-0.5">Authorized by Mrs Sam</Text>
            </View>
          </View>

          {/* Milestone 3: 2:30 PM */}
          <View className="flex-row gap-4">
            <Text className="w-16 text-xs font-bold text-ink pt-0.5">2:30 PM</Text>
            <View className="items-center">
              <View className="w-5 h-5 rounded-full bg-[#F79009] items-center justify-center">
                <View className="w-2 h-2 rounded-full bg-white" />
              </View>
              <View className="w-0.5 h-16 bg-slate-200 my-1" />
            </View>
            <View className="flex-1 pb-4">
              <Text className="text-sm font-bold text-ink">Pickup window opens</Text>
              <Text className="text-xs text-slate-500 mt-0.5">Chidinma's code becomes active</Text>
            </View>
          </View>

          {/* Milestone 4: 3:30 PM */}
          <View className="flex-row gap-4">
            <Text className="w-16 text-xs font-bold text-ink pt-0.5">3:30 PM</Text>
            <View className="items-center">
            ...
            <View className="flex-1 pb-4">
              <Text className="text-sm font-bold text-ink">Pickup window ends</Text>
          ...
          {/* Milestone 5: 3:45 PM */}
          <View className="flex-row gap-4">
            <Text className="w-16 text-xs font-bold text-ink pt-0.5">3:45 PM</Text>
            <View className="items-center">
              <View className="w-5 h-5 rounded-full bg-slate-200 items-center justify-center">
                <View className="w-2 h-2 rounded-full bg-slate-400" />
              </View>
